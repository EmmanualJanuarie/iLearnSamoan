...
const foundationNotes = {
  intro: [
    "Samoan is a Polynesian language written with the Latin alphabet. It is an official language in Samoa and American Samoa.",
    "Use modern written Samoan from the beginning: macrons mark long vowels, and the turned comma marks the glottal stop.",
    "Keep a separate culture notebook. Language, respect, family roles, church life, village life, and formal speech are connected.",
  ],
  alphabet: [
...
const modulePlan: Array<[number, string, string, string]> = [
  [1, "Introduction to Samoan", "Semester 1 - The Language", "Oct 2026"],
  ...
  [5, "Basic Vocabulary", "Semester 1 - The Language", "Jan-Mar 2027"],
  [6, "Pronouns", "Semester 2 - Grammar", "Apr 2027"],
  [7, "Nouns", "Semester 2 - Grammar", "Apr 2027"],
  [8, "Articles", "Semester 2 - Grammar", "May 2027"],
  [9, "Verbs", "Semester 2 - Grammar", "May 2027"],
  [10, "Verb Markers", "Semester 2 - Grammar", "Jun 2027"],
  [11, "Tenses", "Semester 2 - Grammar", "Jun 2027"],
  [12, "Adjectives", "Semester 2 - Grammar", "Jul 2027"],
  [13, "Adverbs", "Semester 2 - Grammar", "Jul 2027"],
  [14, "Prepositions", "Semester 2 - Grammar", "Aug 2027"],
  [15, "Conjunctions", "Semester 2 - Grammar", "Aug 2027"],
  [16, "Question Words", "Semester 2 - Grammar", "Sep 2027"],
  [17, "Negatives", "Semester 2 - Grammar", "Sep 2027"],
  [18, "Possession", "Semester 2 - Grammar", "Sep 2027"],
  [19, "Numbers, Money, Dates, Time, Measurements", "Semester 2 - Grammar", "Sep 2027"],
  [20, "Simple Sentences", "Semester 3 - Sentence Construction", "Oct 2027"],
  [21, "Questions", "Semester 3 - Sentence Construction", "Oct 2027"],
  [22, "Commands", "Semester 3 - Sentence Construction", "Nov 2027"],
  [23, "Descriptions", "Semester 3 - Sentence Construction", "Nov 2027"],
  [24, "Opinions", "Semester 3 - Sentence Construction", "Dec 2027"],
  [25, "Comparisons", "Semester 3 - Sentence Construction", "Jan 2028"],
  [26, "Cause and Effect", "Semester 3 - Sentence Construction", "Jan 2028"],
  [27, "Complex Sentences", "Semester 3 - Sentence Construction", "Feb 2028"],
  [28, "Conversation Grammar", "Semester 3 - Sentence Construction", "Mar 2028"],
  [29, "One Sentence", "Semester 4 - Writing", "Apr 2028"],
  [30, "Five Sentences", "Semester 4 - Writing", "Apr 2028"],
  [31, "Paragraphs", "Semester 4 - Writing", "May 2028"],
  [32, "Descriptions", "Semester 4 - Writing", "May 2028"],
  [33, "Letters", "Semester 4 - Writing", "Jun 2028"],
  [34, "Diary Entries", "Semester 4 - Writing", "Jun 2028"],
...
function createLessons(id: number, title: string): Lesson[] {
  ...
  return [
    ...
    },
    {
      ...
      content: ["Copy model sentences.", "Replace one word at a time.", "Check spelling, macrons, and glottal stops."],
